...
- the [full blocklist](https://github.com/RubenKelevra/ublacklist_conspiracy/blob/master/ublacklist-conspiracy-media-full.txt) from RubenKelevra's [Conspiracy Media blocklist](https://github.com/RubenKelevra/ublacklist_conspiracy) ([CC BY-NC 4.0](https://github.com/RubenKelevra/ublacklist_conspiracy/blob/master/LICENSE)).
- the [full blocklist](https://github.com/RubenKelevra/ublacklist_fakenews/blob/master/ublacklist-fakenews-media-full.txt) from RubenKelevra's [Fake News Media blocklist](https://github.com/RubenKelevra/ublacklist_fakenews) ([CC BY-NC 4.0](https://github.com/RubenKelevra/ublacklist_fakenews/blob/master/LICENSE)).
- the [full blocklist](https://github.com/RubenKelevra/ublacklist_rightwing_media/blob/master/ublacklist-rightwing-media.txt) from RubenKelevra's [Right Wing Media blocklist](https://github.com/RubenKelevra/ublacklist_rightwing_media) ([CC BY-NC 4.0](https://github.com/RubenKelevra/ublacklist_rightwing_media/blob/master/LICENSE)).
